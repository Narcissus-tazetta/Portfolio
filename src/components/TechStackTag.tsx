...
function AppleIcon({ className = "h-3.5 w-3.5" }: { className?: string }) {
    return (
        <svg className={`${className} text-accent-soft`} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
function AppleScriptIcon({ className = "h-3.5 w-3.5" }: { className?: string }) {
    return <Terminal className={`${className} text-accent-soft`} strokeWidth={2} aria-hidden="true" />;
}

function SparkleIcon({ className = "h-3.5 w-3.5" }: { className?: string }) {
    return <Sparkles className={`${className} text-accent-soft`} strokeWidth={2} aria-hidden="true" />;
}

function AVFoundationIcon({ className = "h-3.5 w-3.5" }: { className?: string }) {
