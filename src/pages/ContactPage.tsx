...
export default function ContactPage() {
    ...
    return (
        <div className="site-shell interior-page contact-page">
            <header className="contact-heading"><p className="micro-label chapter-kicker">A conversation is a good start.</p><h1 className="display-title">Say <em>hello.</em></h1><p className="page-intro">{t(contactPage.intro)}</p></header>
