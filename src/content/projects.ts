...
export const projects: Project[] = [
    {
        ...
        thumbnail: "/works/music-autoplay.webp",
        kind: "commissioned",
        category: "app",
    },
    {
        ...
        thumbnail: "/works/auto-attendance.webp",
        kind: "personal",
        category: "extension",
    },
    {
        ...
        thumbnail: "/works/classroom-enhancer.webp",
        kind: "personal",
        category: "extension",
    },
    {
        ...
        thumbnail: "/works/discord-command-chart.webp",
        kind: "personal",
        category: "web",
    },
    {
        ...
        techStack: ["Svelte"],
        thumbnail: "/works/music-autoplay-manual.webp",
        kind: "commissioned",
        category: "web",
    },
    {
        ...
        thumbnail: "/works/questionnaire.webp",
        kind: "commissioned",
        category: "bot",
    },
    {
        ...
        thumbnail: "/works/live-wallpaper-poster.webp",
    ...
    },
    {
        ...
        context: {
            ja: "Minecraft で移動するたびに「ナビがあったら便利なのに」と感じたことが出発点。距離だけでなく、人が実際に通って楽だと感じる道も大切にし、数学的な最適さと移動体験の両立を目指しました。",
            en: "It started with a recurring thought while traveling in Minecraft: navigation would make this easier. I set out to balance mathematical efficiency with routes that feel comfortable to actually travel.",
        },
        ...
        impact: {
            ja: "地形と移動方法を考慮する A* 探索で、歩けるルートを可視化",
            en: "A* search accounts for terrain and movement to visualize walkable routes",
        },
    ...
    },
    {
        ...
        thumbnail: "/works/discord-vc-bot.webp",
        kind: "personal",
        category: "bot",
    },
    {
        ...
        thumbnail: "/works/zzz-discord-reminder.webp",
        kind: "personal",
        category: "bot",
    },
];
